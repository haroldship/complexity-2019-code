...
NLS_Lin_mse <- c(abs(mean((d1$NLSest_gamma11 - theta['gamma11'])))+abs(mean((d1$NLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d1$NLSest_gamma13 - theta['gamma13'])))+abs(mean((d1$NLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d1$NLSest_gamma32 - theta['gamma32']))),
                 abs(mean((d2$NLSest_gamma11 - theta['gamma11'])))+abs(mean((d2$NLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d2$NLSest_gamma13 - theta['gamma13'])))+abs(mean((d2$NLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d2$NLSest_gamma32 - theta['gamma32']))),
                 abs(mean((d3$NLSest_gamma11 - theta['gamma11'])))+abs(mean((d3$NLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d3$NLSest_gamma13 - theta['gamma13'])))+abs(mean((d3$NLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d3$NLSest_gamma32 - theta['gamma32']))))

SLS_Lin_mse <- c(abs(mean((d1$SLSest_gamma11 - theta['gamma11'])))+abs(mean((d1$SLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d1$SLSest_gamma13 - theta['gamma13'])))+abs(mean((d1$SLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d1$SLSest_gamma32 - theta['gamma32']))),
                 abs(mean((d2$SLSest_gamma11 - theta['gamma11'])))+abs(mean((d2$SLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d2$SLSest_gamma13 - theta['gamma13'])))+abs(mean((d2$SLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d2$SLSest_gamma32 - theta['gamma32']))),
                 abs(mean((d3$SLSest_gamma11 - theta['gamma11'])))+abs(mean((d3$SLSest_gamma12 - theta['gamma12'])))
                +abs(mean((d3$SLSest_gamma13 - theta['gamma13'])))+abs(mean((d3$SLSest_gamma22 - theta['gamma22'])))
                +abs(mean((d3$SLSest_gamma32 - theta['gamma32']))))
