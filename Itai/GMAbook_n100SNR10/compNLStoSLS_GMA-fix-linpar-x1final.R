...
for(ip in 1:3){
  ...
  results <- foreach(j=1:N, .packages='simode') %dorng% {
    ...
    while (TRUE) {
      ...
      ptimeNLS <- system.time({
        ...
        #                im_method = "non-separable",
        #                simode_ctrl=simode.control(optim_type = "im"))})
      NLSmc <- simode(equations=equations, pars=pars, fixed=c(x0,theta[1],theta[4],theta[7]), time=time, obs=obs,
                      nlin_pars=nlin_pars,
      ...
      ptimeSLS <- system.time({
        SLSmc <- simode(equations=equations, pars=pars, fixed=c(x0,theta[1],theta[4],theta[7]), time=time, obs=obs,
                        nlin_pars=nlin_pars,
  ...
  loss_df=data.frame(NLSmc=unlist(NLSmc_im_loss_vals),SLSmc=unlist(SLSmc_im_loss_vals),
                     NLSest_f121=NLS_im_vars['f121',],NLSest_f131=NLS_im_vars['f131',],
                     NLSest_f112=NLS_im_vars['f112',],NLSest_f122=NLS_im_vars['f122',],
                     NLSest_f113=NLS_im_vars['f113',],NLSest_f133=NLS_im_vars['f133',],
                     ...
                     SLSest_f121=SLS_im_vars['f121',],SLSest_f131=SLS_im_vars['f131',],
                     SLSest_f112=SLS_im_vars['f112',],SLSest_f122=SLS_im_vars['f122',],
                     SLSest_f113=SLS_im_vars['f113',],SLSest_f133=SLS_im_vars['f133',],
